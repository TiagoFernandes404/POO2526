...
public class DeviceUI {
    ...
    public int showControlMenu() { return controlMenu.show(); }
    public int showGuestMenu()   { return guestMenu.show(); } // ✅ NOVO
    ...
    public String[] readDeviceData() {
        ...
        String extra = "";
        if (type.equals("2")) extra = Menu.readLine("Suporta cor? (s/n): ");
    ...
    public String readDeviceId()        { return Menu.readLine("ID do dispositivo: "); }
    public int readBrightness()         { return Menu.readInt("Brilho (0-100): "); }
    public int readColorTemperature()   { return Menu.readInt("Temperatura de cor em Kelvin (2700-4000): "); }
    public int readVolume()             { return Menu.readInt("Volume (0-100): "); }
    public int readOpeningPercentage()  { return Menu.readInt("Abertura em % (0-100): "); }

    public void displayDevices(List<Device> devices) {
        System.out.println("\n--- Dispositivos ---");
        if (devices.isEmpty()) { System.out.println("Nenhum dispositivo registado."); return; }
        for (Device d : devices) System.out.println(d.getStatus());
    }
