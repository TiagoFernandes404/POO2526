...
import domuscontrol.model.actions.SetBrightnessAction;
import domuscontrol.model.actions.SetOpeningAction;
import domuscontrol.model.actions.SetVolumeAction;
import domuscontrol.model.actions.TurnOffAction;
...
public class ControllerTotal {
    ...
    private void listDevicesOfUser() {
        List<Device> todos = loggedUser.getAllHouses().stream()
        ...
        try {
            switch (choice) {
                ...
                case 4 -> {
                    ...
                    a.setOpeningPercentage(deviceUI.readOpeningPercentage(), currentTotalMinutes());
    ...
    private void executeScenario() {
        ...
        try {
            controller.executeScenario(name, currentTotalMinutes()); // ← passa minuto
